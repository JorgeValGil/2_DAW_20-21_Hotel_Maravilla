                ...
                <div class="col">
                    <div class="col">
                        ...
                        <div class="row justify-content-center">
                            <?php
                            if (isset($_GET['id_room']) && isset($_GET['start']) && isset($_GET['end'])&& isset($_GET['id_user'])) {
                                $reserva = new \functionsUsers\Admin();
                                $array_datos = array($_GET['id_user'],$_GET['start'], $_GET['end'],$_GET['id_room']);
                                $html = $reserva->anadir_reserva($array_datos);

                                if ($html){
                                    echo "<h3>The reservation has been created successfully. You will receive an email when an administrator accepts it.</h3>";
                                }else{
                                    echo "<h3>The reservation could not be made, system failure.<a href='../index.php'> Back to Index</a></h3>";
                                }
                            } else {
                                echo "<h2>There was an error during the process.<a href='../index.php'> Back to Index</a></h2>";
                            }
                            ?>
