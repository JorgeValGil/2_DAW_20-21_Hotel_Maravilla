    ...
    <body>
        ...
        <div class="container mb-3 fondo-claro">
            ...
            <div class="row">
                <div class="col">
                    <div class="col">
                        ...
                        <h3 class="display-5 bg-secondary text-white mb-1 mt-2 text-center"><?php
                            if (isset($_GET['tipo'])) {
                                echo $_GET['tipo'] . ' Rooms';
                            }
                            ?></h3>
                        <p id="aviso" style="color: red; font-weight: bold"></p>
                        <div class="row justify-content-center">
                            <?php
                            if (isset($_GET['tipo']) && isset($_GET['start']) && isset($_GET['end'])) {
                                $habitacion = new \functionsUsers\Conexion();
                                $array_datos = array($_GET['start'], $_GET['end'], $_GET['tipo']);
                                $html = $habitacion->cargar_habitacion_tipo($array_datos);

                                echo $html;
                            } else {
                                echo "<h2>You must select a type of room.<a href='rooms.php'> Back to rooms</a></h2>";
                            }
                            ?>
            ...
            <script type="text/javascript">
                ...
                Object.keys(document.getElementsByClassName("boton_reserva")).forEach(
                        (element) => {
                    document
                            .getElementsByClassName("boton_reserva")
                    [element].addEventListener("click", (a) => {

                        a.preventDefault();
                        console.log(a);

                        var id_room = document.getElementsByClassName("boton_reserva")[element]
                                .value;
                        console.log(id_room);
                        ...
                        if (id_user != "no_login") {
                            if (start != "" && end != "" && id_room != "" && id_user != "no_login") {
                                window.location.href =
                                        "/Proxecto/html/reservas.php?id_user=" +
                                        id_user +
                                        "&start=" +
                                        start +
                                        "&end=" +
                            ...
                            aviso.innerHTML = "Please log in to make a reservation.";
                        }
                    });
                }
                );
