                    ...
                    <div class="col">
                        <div class="row justify-content-center">
                            ...
                            <div class="col col-12 col-md-12 col-sm-12">
                                <h3 class="display-5 bg-secondary text-white mb-1 mt-2 text-center">Our Location</h3>
                                <p class="texto">Our Hotel is located on Avenida de Galicia, 101 in Vigo, Pontevedra, Spain.<br>
                                    Postal Code: 36216</p>

                                <p class="texto">Our hotel is located in the Teis area, 10.7km from Peinador airport, 4.6km from Plaza de España and 5.9km from Rande Bridge.</p>
                                <div class="map">
                                    <iframe src="https://maps.google.com/maps?q=Avenida%20de%20Galicia,%20101&t=k&z=9&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no">
                                    </iframe>
                                </div> 
                            </div>
                        </div>
